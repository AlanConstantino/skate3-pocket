...
class DriverStoreInstrumentation : Instrumentation() {
    ...
    override fun onStart() {
        ...
        try {
            ...
            runCase("Fresh selection initializes existing bundled T30 default") {
                expect(DriverBridge.selected(ctx) == DriverBridge.T30, "fresh default T30")
                expect(prefs.getString("selected", null) == DriverBridge.T30, "default committed")
            }
